    ...
    <div class="min-h-screen flex items-center justify-center">
        <BaseCard class="w-full max-w-md">
            ...
            <form @submit.prevent="handleRegister">
                ...
                <BaseInput v-model="userData.phoneNumber" type="tel" label="Phone Number (Optional)" placeholder="Enter phone number"/>
...
<script setup>
    ...
    const validateForm = () => {
        ...
        if (!userData.value.pin || userData.value.pin.length < 4) errors.value.pin = 'PINs must be 4-6 digits'
